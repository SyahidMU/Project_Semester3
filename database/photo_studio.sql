...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Des 2023 pada 18.51
...
(1, 'Syahid Mu', '085697482053', 'amperakoding', '2018-07-23 11:16:57', 'adminSyahid', '2023-12-16 00:47:42');
...
INSERT INTO `paket` (`id_paket`, `nama_paket`, `harga`, `foto`, `created_by`, `created_at`, `modified_by`, `modified_at`) VALUES
(7, 'Paket Foto 1', 100000, 'paket-foto-120231215211309.jpg', 'superadmin', '2023-12-15 20:55:11', 'adminSyahid', '2023-12-16 00:36:34'),
(8, 'Paket Foto 2', 200000, '', 'adminSyahid', '2023-12-16 00:36:23', '', NULL),
(9, 'Paket Foto 3', 300000, '', 'adminSyahid', '2023-12-16 00:36:58', '', NULL),
(10, 'Paket Foto 4', 400000, '', 'adminSyahid', '2023-12-16 00:37:10', 'adminSyahid', '2023-12-16 00:48:39');
...
(1, 1, 'Slider 1', 'http://www.yahoo.com ', '120231216003022', '.jpeg', 203, '2017-11-25 08:05:03', 'amperakoding', '2023-12-16 00:30:22', 'adminSyahid'),
(2, 2, 'Slider 2', 'http://www.google.com ', '220231216003123', '.jpeg', 833, '2017-11-25 08:05:03', 'amperakoding', '2023-12-16 00:31:23', 'adminSyahid'),
(3, 3, 'slider 3', 'http://www.facebook.com', '320231216003536', '.jpg', 167, '2017-11-25 08:05:03', 'amperakoding', '2023-12-16 00:35:36', 'adminSyahid');
...
(9, 'J-231214-0001', 1, 40000000, 0, 40000000, '2023-12-15 22:05:19', '', 2, '2023-12-14', '11:28:18'),
(10, 'J-231215-0002', 1, 0, 0, 0, '0000-00-00 00:00:00', '', 0, '2023-12-15', '09:09:03');
...
INSERT INTO `transaksi_detail` (`id_transdet`, `trans_id`, `paket_id`, `tanggal`, `jam_mulai`, `durasi`, `jam_selesai`, `harga_jual`, `total`, `created_at`) VALUES
(15, 9, 7, '2023-12-20', '21:00:00', 2, '23:00:00', 20000000, 40000000, '2023-12-15 21:04:44'),
(16, 10, 7, '0000-00-00', NULL, 0, NULL, 20000000, 20000000, '2023-12-15 21:09:03'),
(17, 10, 8, '0000-00-00', NULL, 0, NULL, 200000, 200000, '2023-12-16 00:37:24');
...
(1, 'adminSyahid', 'adminSyahid', '$2y$08$TWMdtdacqPE5yEz9n1LwFuhEVmiDTTsupl12M45tCQihzF1tu2N/6', 'superadmin@gmail.com', '085697482053', 6, 151, 'Cikampek Baru', 1, 1, 'adminsyahid20231216001139', '.jpg', '::1', NULL, 'c6ad242e6fd3de875568c7de5ba23af4a24137ef', 'tHafW45duPzrU3oWR0AVuO48b26088a3cd65edc4', 1621246176, 'p74yuqHG9uNmPi28alTILO', 1702660338, 2147483647, '2023-12-16 00:12:18'),
(5, 'Syahid MU', 'adminSyahid', '$2y$08$HlW9pMJai6uj93btJ2ULoODDdTqtF9syP97soT.7IZW/uLS67VimG', 'xcplus.tsm.syahid@gmail.com', '085697482053', 9, 171, 'Cikampek Baru', 4, 1, NULL, NULL, '::1', NULL, NULL, NULL, NULL, '5bUOMYBsJ6JLp3TB.Nca2O', 1702648255, 1702648226, '2023-12-15 20:50:55');
...
ALTER TABLE `transaksi_detail`
  ...
  ADD KEY `transaksi_detail_FK` (`paket_id`),
...
--
ALTER TABLE `transaksi_detail`
  ADD CONSTRAINT `transaksi_detail_FK` FOREIGN KEY (`paket_id`) REFERENCES `paket` (`id_paket`) ON DELETE CASCADE ON UPDATE CASCADE,
