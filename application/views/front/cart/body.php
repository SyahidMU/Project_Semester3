		...
		<div class="col-lg-12">
			...
			<form action="<?php echo base_url('cart/checkout') ?>" method="post">
							...
							<table id="datatable" class="table table-striped table-bordered">
								...
								<tbody>
									...
									foreach ($cart_data as $cart) { ?>
										<tr>
											<td style="text-align:left"><?php echo $cart->nama_paket ?></td>
											...
											<td style="text-align:center">
												...
												<input type="hidden" name="paket[]" value="<?php echo $cart->paket_id ?>">
												<input type="hidden" name="id_transdet[]" value="<?php echo $cart->id_transdet ?>">
												<input type="hidden" value="<?php echo $cart->paket_id; ?>" class="paket_id">
											</td>
											<td style="text-align:center">
				...
				<?php if (!empty($customer_data->id_trans)) { ?>
					<div class="row">
						<div class="col-lg-12">
							<?php if (!empty($cek_keranjang->paket_id)) { ?>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('.tanggal').on('changeDate', function(ev) {
					...
					paket_id_el = tanggal_el.parent().parent().find(".paket_id");
