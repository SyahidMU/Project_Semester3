            ...
            <?php echo form_open_multipart($action);?>
                ...
                <div class="box-body">
                  <div class="form-group"><label>Nama Paket</label>
                    <?php echo form_input($nama_paket, $paket->nama_paket);?>
                  </div>
                  <div class="form-group"><label>Harga Per Jam</label>
                    <?php echo form_input($harga, $paket->harga);?>
                  </div>
                  <div class="form-group"><label>Foto Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/paket/'.$paket->foto.'') ?>" width="300px" class="img-responsive"/>
                  </div>
