  ...
  <div class="row">
    ...
    <div class='col-lg-3'>
      <div class='small-box bg-green'>
        <div class='inner'><h3> <?php echo $total_paket ?> </h3><p><b>PAKET</b></p></div>
        <div class='icon'><i class='fa fa-list'></i></div>
        <a href='<?php echo base_url('admin/paket') ?>' class='small-box-footer'>Selengkapnya <i class='fa fa-arrow-circle-right'></i></a>
      </div>
    </div>
    <div class='col-lg-3'>
