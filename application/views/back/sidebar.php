<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if($this->uri->segment(2) == "paket"){echo "class='active'";} ?>>
        <a href='#'><i class='fa fa-list'></i><span> Paket </span><i class='fa fa-angle-left pull-right'></i></a>
        <ul class='treeview-menu'>
          <li <?php if($this->uri->segment(2) == "paket" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>><a href='<?php echo base_url('admin/paket/create') ?>'><i class='fa fa-circle-o'></i> Tambah Paket </a></li>
          <li <?php if($this->uri->segment(2) == "paket" && $this->uri->segment(3) == ""){echo "class='active'";} ?>><a href='<?php echo base_url('admin/paket') ?>'><i class='fa fa-circle-o'></i> Data Paket </a></li>
        </ul>
      </li>
