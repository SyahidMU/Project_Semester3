...
class Cart_model extends CI_Model
{
  ...
  {
    $this->db->select('
    paket.id_paket, paket.nama_paket,
    ...
    transaksi_detail.trans_id, transaksi_detail.paket_id, transaksi_detail.tanggal, transaksi_detail.jam_mulai, transaksi_detail.durasi, transaksi_detail.jam_selesai, transaksi_detail.harga_jual, transaksi_detail.total,
    provinsi.nama_provinsi,kota.nama_kota,
    users.id, users.name, users.address
    ');
    $this->db->join('paket', 'transaksi_detail.paket_id = paket.id_paket');
  ...
  function get_bulan()
  {
    $this->db->select('judul_paket, transaksi.created as tanggal');
